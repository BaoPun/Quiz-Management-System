...
public class QuizTeacherLoginStepImpl {
	...
	public void the_teacher_fill_username_field_with_for_login(String arg1) throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    
	}

	@When("^The teacher fill password with \"([^\"]*)\" for login$")
	public void the_teacher_fill_password_with_for_login(String arg1) throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
